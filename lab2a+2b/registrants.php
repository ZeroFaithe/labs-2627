...
define('registrars_FILE_PATH', 'registrations.csv');

function get_hundred_registrars_data()
{
    $opened_file_handler = fopen(registrars_FILE_PATH, 'r');
    ...
    $registrars = get_hundred_registrars_data();
?>
<html>
<head>
    <meta charset="utf-8">
...
<table aria-label="Registrars Dataset">
    <thead>
        <tr>
            <th>Complete Name</th>
            <th>Birthday</th>
    ...
    <tbody>
    <?php
    foreach ($registrars['data'] as $record):
    ?>
        <tr>
